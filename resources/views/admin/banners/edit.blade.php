...
<div class="max-w-xl mx-auto">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-xl font-black text-gray-900 dark:text-white">Edit Banner</h2>
    </div>
    ...
    <form action="{{ route('admin.banners.update', $banner) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-6 space-y-5">
            ...
            <div x-data="{ preview: null }">
                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-200 mb-1.5">Gambar Banner</label>
                <img :src="preview || '{{ $banner->gambar_url }}'" class="w-full aspect-video object-cover rounded-2xl mb-3">
                <label class="block cursor-pointer border-2 border-dashed border-gray-200 dark:border-gray-600 rounded-xl p-4 text-center hover:border-primary-400 transition">
            ...
            <div>
                ...
                <input type="text" name="judul" value="{{ old('judul', $banner->judul) }}" required
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="2"
                          class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl text-sm focus:ring-2 focus:ring-primary-500 outline-none dark:text-white transition resize-none">{{ old('deskripsi', $banner->deskripsi) }}</textarea>
            </div>

            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-200 mb-1.5">Link</label>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="urutan" value="{{ old('urutan', $banner->urutan) }}" min="0"
                           class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl text-sm focus:ring-2 focus:ring-primary-500 outline-none dark:text-white transition">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-200 mb-1.5">Status</label>
                    <div x-data="{ checked: {{ $banner->is_active ? 'true' : 'false' }} }" class="flex items-center gap-3 h-[50px]">
